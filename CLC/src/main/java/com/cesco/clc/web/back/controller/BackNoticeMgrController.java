 ...
 */
@Controller
@RequestMapping("/back/community/notice")
public class BackNoticeMgrController extends SimpleMapServiceController{
	
	private static final Logger logger = LoggerFactory.getLogger(BackNoticeMgrController.class);
    ...
    public String main(HttpServletRequest req, HttpServletResponse res, ModelMap model) throws Exception {
	    ...
	    return "/back/pages/community/notice/list";
    }
    ...
    public String view(HttpServletRequest req, HttpServletResponse res, ModelMap model) throws Exception {
	    ...
	    return "/back/pages/community/notice/view";
    }
