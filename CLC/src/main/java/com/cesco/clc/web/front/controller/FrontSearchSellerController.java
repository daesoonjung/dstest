...
public class FrontSearchSellerController extends SimpleMapServiceController{
	
	private static final Logger logger = LoggerFactory.getLogger(FrontSearchSellerController.class);

	
	@RequestMapping(value = "/srchseller")
    public String help(HttpServletRequest req, HttpServletResponse res, ModelMap model) throws Exception {
	    ...
	    return "/front/pages/service/srchseller";
    }
}
