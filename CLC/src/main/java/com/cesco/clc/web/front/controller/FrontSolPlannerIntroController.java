...
public class FrontSolPlannerIntroController extends SimpleMapServiceController{
	
	private static final Logger logger = LoggerFactory.getLogger(FrontSolPlannerIntroController.class);
