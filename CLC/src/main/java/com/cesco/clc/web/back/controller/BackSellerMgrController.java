...
public class BackSellerMgrController extends SimpleMapServiceController{
	
	private static final Logger logger = LoggerFactory.getLogger(BackSellerMgrController.class);
