 ...
 */
@Controller
@RequestMapping("/back/community/faq")
public class BackFaqMgrController extends SimpleMapServiceController{
	
	private static final Logger logger = LoggerFactory.getLogger(BackFaqMgrController.class);
    ...
    public String main(HttpServletRequest req, HttpServletResponse res, ModelMap model) throws Exception {
	    ...
	    return "back/pages/community/faq/list";
    }
    ...
    public String view(HttpServletRequest req, HttpServletResponse res, ModelMap model) throws Exception {
	    ...
	    return "back/pages/community/faq/view";
    }
