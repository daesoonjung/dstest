...
public class FileunZip {
     ...
     * 파일확장자 체크(복수)
     */
    public static boolean unZip(String zipPath, String zipFileName, String zipUnzipPath) throws Exception{
    ...
    public static List<Map<String, Object>> unZipFileList(String zipPath, String zipFileName, String zipUnzipRootDir, String originalName) throws Exception{
    	// 파일 정상적으로 압축이 해제가 되어는가. 
    	boolean isChk = false;
    	List<Map<String, Object>>  flist  = new ArrayList<Map<String, Object>>();
    	// 해제할 홀더 위치를 재조정 
    	String zipUnzipPath = zipUnzipRootDir +"/"+ zipFileName.replace(".zip", "");
    	
    	Map<String, Object> tMap = new HashMap<String, Object>();
    	tMap.put("depth", "0");
    	tMap.put("fullpath", zipPath);
    	tMap.put("dirpath", zipUnzipPath);
    	tMap.put("filename", zipFileName);
    	tMap.put("originalName", originalName);
    	flist.add(tMap);
    	// zip 파일
    	File zipFile = new File(zipPath);
    	...
    	try {
    		...
    		while ((zipentry = zis.getNextEntry()) != null) {
    			...
    			fMap.put("depth", "1");
    			fMap.put("dirpath", zipUnzipPath);
    			fMap.put("fullpath", zipUnzipPath+"/"+filename);
    			fMap.put("filename", filename);
    			fMap.put("originalName", "");
    	    	flist.add(fMap);
    		}
    		isChk = true;
    	}catch (Exception e) { 
    ...
    */
     ...
     * 파일 만들기 메소드 
     * 
     * @param file 파일 * @param zis Zip스트림 
     **/
